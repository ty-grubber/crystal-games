const REGIONS = [
  ...
  { id: 4, name: 'Azalea', locations: ['Azalea', 'Ilex', 'Slowpoke Well', 'Kurt', 'Bugsy', 'Charcoal', 'Headbutt', 'King\'s Rock', 'Soft Sand', 'Sweet Scent'], routes: [33, 34], description: 'Azalea, Ilex + Rts 33, 34' },
  { id: 5, name: 'Goldenrod', locations: ['Goldenrod', 'National Park', 'Underground Bargain', 'Underground Herb', 'Radio', 'Bike Shop', 'Buena', 'Department Store Basement', 'Flower Shop', 'Kenya', 'Bug Catching', 'Whitney', 'Coin Case'], routes: [34, 35], description: 'Goldenrod, National Park + Rt 35' },
  ...
  { id: 13, name: 'Central Kanto', locations: ['Cerulean', 'Saffron', 'Celadon', 'Vermilion', 'Copycat', 'Dojo', 'Erika', 'Machine Part', 'Bills Grandpa', 'Mr Psychic', 'Silph Co', 'Underground Path'], routes: [24, 25, 5, 17], description: 'Cerulean, Saffron, Celadon, Vermillion + Rts 24, 25, 5, 17' },
