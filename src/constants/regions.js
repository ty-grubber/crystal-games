const REGIONS = [
  ...
  { id: 4, name: 'Azalea', locations: ['Azalea', 'Ilex', 'Slowpoke Well', 'Kurt', 'Bugsy', 'Charcoal', 'Headbutt', 'King\'s Rock'], routes: [33, 34], description: 'Azalea, Ilex + Rts 33, 34' },
  { id: 5, name: 'Goldenrod', locations: ['Goldenrod', 'National Park', 'Underground', 'Radio', 'Bike Shop', 'Buena', 'Department Store Basement', 'Flower Shop', 'Kenya', 'Bug Catching', 'Soft Sand', 'Sweet Scent', 'Whitney'], routes: [34, 35], description: 'Goldenrod, National Park + Rt 35' },
